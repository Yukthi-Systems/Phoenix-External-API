...
pub async fn generate_upload_sessions(base_url: &str, api_key: &str, body: &serde_json::Value) -> Result<serde_json::Value, AppError> {
...
pub async fn generate_download_sessions(base_url: &str, api_key: &str, body: &serde_json::Value) -> Result<serde_json::Value, AppError> {
    let client = Client::new();
...
/// Request to create a WOPI session on the storage server
pub async fn create_wopi_session(base_url: &str, api_key: &str, body: &serde_json::Value) -> Result<serde_json::Value, AppError> {
    let client = Client::new();
